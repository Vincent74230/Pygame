...
class Rand_items:
    ...
    def rand_items(self):
        ...
        # Generation of n other couples of coordinates :
        #according to the amount of random items we want to set up in the maze
            while self.level[item_coordinates[i][0]][item_coordinates[i][1]] != 0\
            and item_coordinates[i] != item_coordinates[i-1]:
